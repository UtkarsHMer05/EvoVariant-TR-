...
- In the user's existing Vivaldi Colab tab, the free Tesla T4 run completed the Caduceus smoke
  ...
  active on Drive; the latest observed worker was PID 58018 at 2:01:25 with trial 0 RUNNING,
  trials 1–3 WAITING, four persisted epochs for fold 0, and three for fold 1. The study/selection
  lock remains open.
