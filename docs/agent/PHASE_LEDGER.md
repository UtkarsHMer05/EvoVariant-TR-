...
| 18 | Security + clean-room reproducibility | BLOCKED / CONTROL SURFACE ONLY | Fresh clone from `27352e5` passes bootstrap, secret scan, Ruff, strict mypy, 714-test validation, 95.01% coverage, registry/protocol/schema/model checks, frontend build, and all four browser E2E journeys. `make clean-room` remains `BLOCKED`: full scientific Modal reproduction and complete figure-source regeneration are unrun. |
